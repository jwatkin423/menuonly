<div class="form-group{{ $errors->has('address_one') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        {!! Form::text('address_one', $user->address->address_one, ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('address_two') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        {!! Form::text('address_two', $user->address->address_two, ['class' => 'form-control']) !!}
...
<div class="form-group{{ $errors->has('zip_code') ? ' has-error' : '' }}">
    ...
    <div class="col-md-6">
        {!! Form::text('zip_code', $user->address->zip_code, ['class' => 'form-control']) !!}
